...
type ComplexityRoot struct {
	...
	Query struct {
		Login func(childComplexity int, input LoginParams) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.login":
		...
		return e.complexity.Query.Login(childComplexity, args["input"].(LoginParams)), true
	case "Query.task":
...
func (ec *executionContext) field_Query_login_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNloginParams2githubᚗcomᚋsjᚑdistributorᚋdolphinᚑexampleᚋgenᚐLoginParams)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) unmarshalInputloginParams(ctx context.Context, obj any) (LoginParams, error) {
	var it LoginParams
	asMap := map[string]any{}
	for k, v := range obj.(map[string]any) {
		asMap[k] = v
...
func (ec *executionContext) unmarshalNloginParams2githubᚗcomᚋsjᚑdistributorᚋdolphinᚑexampleᚋgenᚐLoginParams(ctx context.Context, v any) (LoginParams, error) {
