...
type UploadFileResultTypeResolver struct {
	*gen.GeneratedUploadFileResultTypeResolver
}

func (r *Resolver) UploadFileResultType() gen.UploadFileResultTypeResolver {
	return &UploadFileResultTypeResolver{&gen.GeneratedUploadFileResultTypeResolver{GeneratedResolver: r.GeneratedResolver}}
}
