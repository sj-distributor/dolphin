...
- Go 1.25.5 + gqlgen v0.17.85, graphql-go/graphql v0.8.1 (004-fix-input-directive)
...
## Recent Changes
- 007-extension-api-code-field: Added [if applicable, e.g., PostgreSQL, CoreData, files or N/A]
